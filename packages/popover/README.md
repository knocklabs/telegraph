...
<Popover.Root>
  ...
  <Popover.Content px="4" py="3" maxW="80">
    <Stack direction="column" gap="2">
      ...
      <p>
        John has been working on the platform team for 3 years, focusing on
...
import { Stack } from "@telegraph/layout";
import { Popover } from "@telegraph/popover";
import { Archive, Copy, Download, Share, Trash } from "lucide-react";
          ...
          <Stack direction="row" wrap="wrap" gap="2" maxW="48">
            {colors.map((color) => (
              <Box
                ...
                border="2"
                borderColor={
                  selectedColor === color ? "accent-9" : "transparent"
                }
                onClick={() => {
