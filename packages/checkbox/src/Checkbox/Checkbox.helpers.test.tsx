...
describe("countLabels", () => {
  it("returns 0 when there is nothing to find", () => {
    ...
    expect(count("Cancel this run")).toBe(0);
  ...
  // because that component has not been called yet. `Checkbox.Control` then
  // leaves `aria-labelledby` unset and Base UI names the control from the
  // rendered `<label for>` instead.
