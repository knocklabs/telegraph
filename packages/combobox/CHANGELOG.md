...
- Updated dependencies [[`84d5ee4`](https://github.com/knocklabs/telegraph/commit/84d5ee4fd3dc1e0dfeb528d6eb3da39211cdef4a), [`f88b8c0`](https://github.com/knocklabs/telegraph/commit/f88b8c08b36c10df0098702b9da85ff24be9d5c6)]:
  - @telegraph/button@0.9.2
  - @telegraph/tag@0.3.4
  - @telegraph/tooltip@0.6.4
  - @telegraph/truncate@0.3.2
...
- [#912](https://github.com/knocklabs/telegraph/pull/912) [`d810993`](https://github.com/knocklabs/telegraph/commit/d810993d5b704dffcb2b5b1c0d80b03032dd3b2a) Thanks [@kylemcd](https://github.com/kylemcd)! - Add the input-as-trigger arrangement to `@telegraph/combobox`. This is additive — the existing button-`Trigger` API is unchanged.
  ...
  `Combobox.Root` gains a free-text mode via `selectionMode="none"`, which renders Base UI's Autocomplete root: the input text is the state and there is no selected value, so any typed text is valid and pressing a suggestion fills the input. New additive `Root` props support both arrangements: `selectionMode`, `inputValue` / `defaultInputValue` / `onInputValueChange`, `autocompleteMode`, `autoHighlight`, `openOnInputClick`, `loopFocus`, and `actionsRef`. `onOpenChange` now also receives an optional Base UI change-details argument (existing single-argument handlers are unaffected). The existing `onItemHighlighted` callback works for the new arrangements too.

- [#977](https://github.com/knocklabs/telegraph/pull/977) [`21b58fa`](https://github.com/knocklabs/telegraph/commit/21b58faabdf09a7075d9bc22cc78ca6ad47bd701) Thanks [@kylemcd](https://github.com/kylemcd)! - **Breaking:** Remove the deprecated `legacyBehavior` prop and `{ value, label }` selection values. `value` and `defaultValue` now use strings or string arrays only. `onValueChange` reports strings or string arrays, and reports `undefined` when a single selection is cleared. `Combobox.Create` values and `onCreate` are string-only too.
...
- [#929](https://github.com/knocklabs/telegraph/pull/929) [`4524eff`](https://github.com/knocklabs/telegraph/commit/4524eff00a989fecbe09f894b84f8b436daacbc1) Thanks [@kylemcd](https://github.com/kylemcd)! - Add a segmented "pages" arrangement to `Combobox`. A `Combobox.PageSelector` (holding `Combobox.PageButton`s) pinned in the popup switches between `Combobox.Page` panels of options. Left/Right arrows switch pages while the search is empty (or when there is no search); Up/Down keep navigating the active page's list. The active page is controllable via `page`/`defaultPage`/`onPageChange` on `Combobox.Root`, and only the active page's options mount so highlight bounds and `Combobox.Empty` stay correct. `loopPages` (default `true`) controls whether Left/Right wraps around at the first/last page — set it to `false` to clamp at the ends.
...
- [#907](https://github.com/knocklabs/telegraph/pull/907) [`e965228`](https://github.com/knocklabs/telegraph/commit/e965228a74285dee1bf0906c3c597e399da9245b) Thanks [@kylemcd](https://github.com/kylemcd)! - Restore controlled search and popup keyboard propagation compatibility after the Base UI rewrite.
...
- [#972](https://github.com/knocklabs/telegraph/pull/972) [`ae9d253`](https://github.com/knocklabs/telegraph/commit/ae9d253227fbd8c9e4e82d0e43359ae2f9cf581e) Thanks [@kylemcd](https://github.com/kylemcd)! - Honor canceled `onInputValueChange` events before updating the internal search query, and preserve a multi-select search while the popup stays open. Consumers can intercept pasted text without retaining it as a query and select several filtered options in succession.
...
- Updated dependencies [[`5e9e6b4`](https://github.com/knocklabs/telegraph/commit/5e9e6b40311e69c04f17ef0f7dff1d9adf877013), [`7523f70`](https://github.com/knocklabs/telegraph/commit/7523f7018cc38641eb617e8cffc247c484ccb094)]:
...
- [#960](https://github.com/knocklabs/telegraph/pull/960) [`3a9004a`](https://github.com/knocklabs/telegraph/commit/3a9004a2657ef2d4ff8279af973dfc2151540676) Thanks [@kylemcd](https://github.com/kylemcd)! - fix(combobox): stop `Combobox.Trigger` stretching to a definite-height ancestor
...
- Updated dependencies [[`5015089`](https://github.com/knocklabs/telegraph/commit/5015089fd7a94dde8214ef383fa78d86c3aec688)]:
  ...
  - @telegraph/menu@0.6.1
  - @telegraph/icon@0.6.1
  - @telegraph/input@0.5.1
  - @telegraph/layout@0.6.2
  - @telegraph/tag@0.3.1
  - @telegraph/tooltip@0.6.1
...
- Updated dependencies [[`d6ee028`](https://github.com/knocklabs/telegraph/commit/d6ee028d4cd649a287076ab5f1b9a94e0a2b5eef), [`028dd83`](https://github.com/knocklabs/telegraph/commit/028dd8337dadb4df0971ef20af6b275338385a9e)]:
  - @telegraph/menu@0.5.4
...
- Updated dependencies [[`1de6cf1`](https://github.com/knocklabs/telegraph/commit/1de6cf1874835db4389f5e7f14fbcc694229a5de), [`d3b6fee`](https://github.com/knocklabs/telegraph/commit/d3b6fee0e7cd308151efdc5921164d324ccaf045)]:
  ...
  - @telegraph/input@0.3.1
  - @telegraph/tag@0.1.5
  - @telegraph/truncate@0.1.1
  - @telegraph/layout@0.5.0
...
- Updated dependencies [[`8ceb949`](https://github.com/knocklabs/telegraph/commit/8ceb949883d1df0bc279af1cbbdaead64a25e49e)]:
  ...
  - @telegraph/menu@0.1.16
  - @telegraph/tag@0.0.111
  - @telegraph/tooltip@0.0.60
  - @telegraph/icon@0.3.2
  - @telegraph/truncate@0.0.15

## 0.1.19

### Patch Changes

- Updated dependencies [[`0def9d5`](https://github.com/knocklabs/telegraph/commit/0def9d56bfe6ce7279a28b7fcdaa0e6ad88a6c80)]:
  - @telegraph/tag@0.0.110

## 0.1.18

### Patch Changes

- Updated dependencies [[`aeb1c2b`](https://github.com/knocklabs/telegraph/commit/aeb1c2bf0db098320ecc960debf7f99ce0bb35d3), [`2789747`](https://github.com/knocklabs/telegraph/commit/27897474bb1885ff126513205557f2a60242b82c), [`7c5f127`](https://github.com/knocklabs/telegraph/commit/7c5f127d945bfe3a171032195e214454ac4291cf), [`5901b31`](https://github.com/knocklabs/telegraph/commit/5901b317bef94ae6ff3903ed5c8129bde6a4532b)]:
  - @telegraph/layout@0.3.0
  - @telegraph/input@0.1.4
  - @telegraph/button@0.3.1
  - @telegraph/typography@0.1.26
  - @telegraph/menu@0.1.15
  - @telegraph/tag@0.0.109
  - @telegraph/tooltip@0.0.59
  - @telegraph/icon@0.3.1
  - @telegraph/truncate@0.0.14
...
- Updated dependencies [[`8d9f23c`](https://github.com/knocklabs/telegraph/commit/8d9f23cdc43701b6a281cd4ac0c6a1d5fdfe107a)]:
  ...
  - @telegraph/menu@0.1.14
  - @telegraph/tag@0.0.108
...
- Updated dependencies [[`0073505`](https://github.com/knocklabs/telegraph/commit/00735055f9078e61ac4b31d7bc306b57c5fc6c7b)]:
  ...
  - @telegraph/menu@0.1.13
  - @telegraph/tag@0.0.107
...
- Updated dependencies [[`17a3409`](https://github.com/knocklabs/telegraph/commit/17a34098ee1c6c83ba9dd7ff65255161f2ff094c)]:
  ...
  - @telegraph/menu@0.1.12
  - @telegraph/tag@0.0.106
...
- Updated dependencies [[`3c4a714`](https://github.com/knocklabs/telegraph/commit/3c4a7142e9e9272701f924162ca938d548fef625)]:
  ...
  - @telegraph/menu@0.1.11
  - @telegraph/tag@0.0.105
...
- Updated dependencies [[`322bf1e`](https://github.com/knocklabs/telegraph/commit/322bf1e463b0a2a5b83899843d8ea54004b89b9b)]:
  ...
  - @telegraph/input@0.1.3
  - @telegraph/menu@0.1.10
  - @telegraph/tag@0.0.104
  - @telegraph/tooltip@0.0.58
  - @telegraph/typography@0.1.25
  - @telegraph/truncate@0.0.13
...
- Updated dependencies []:
  ...
  - @telegraph/input@0.1.2
  - @telegraph/menu@0.1.9
  - @telegraph/tag@0.0.103
  - @telegraph/tooltip@0.0.57
  - @telegraph/truncate@0.0.12
...
- Updated dependencies [[`4834ada`](https://github.com/knocklabs/telegraph/commit/4834ada4a00cdf8a9a1e524092f644d503cd3646)]:
  ...
  - @telegraph/menu@0.1.8
  - @telegraph/tag@0.0.102
...
- Updated dependencies [[`4817bf4`](https://github.com/knocklabs/telegraph/commit/4817bf496e77214d5a99426d4a559e99fd98e8f0)]:
  ...
  - @telegraph/menu@0.1.6
  - @telegraph/tag@0.0.99
...
- [#565](https://github.com/knocklabs/telegraph/pull/565) [`b25935f`](https://github.com/knocklabs/telegraph/commit/b25935f52cc1af004b65704762e5729679493cdf) Thanks [@dependabot](https://github.com/apps/dependabot)! - chore(deps): bump @radix-ui/react-menu from 2.1.15 to 2.1.16
...
- Updated dependencies [[`45d2fe1`](https://github.com/knocklabs/telegraph/commit/45d2fe1284b97f984fb08f118e25a9d6bc58c353), [`bad64d8`](https://github.com/knocklabs/telegraph/commit/bad64d8996ba2304dc84ca81d0393bff5844fc96)]:
  ...
  - @telegraph/input@0.0.45
  - @telegraph/tag@0.0.88
  - @telegraph/typography@0.1.18
  - @telegraph/truncate@0.0.4
...
- Updated dependencies []:
  ...
  - @telegraph/input@0.0.44
  - @telegraph/menu@0.0.66
  - @telegraph/motion@0.0.8
  - @telegraph/tag@0.0.87
  - @telegraph/tooltip@0.0.48
  - @telegraph/truncate@0.0.3
...
- Updated dependencies []:
  ...
  - @telegraph/tag@0.0.80
  - @telegraph/input@0.0.41
  - @telegraph/tooltip@0.0.43
...
- Updated dependencies [[`fdfe94c`](https://github.com/knocklabs/telegraph/commit/fdfe94cee527ace65603b7c9033db27105fb05a7)]:
  - @telegraph/menu@0.0.58
...
- Updated dependencies [[`061bb93`](https://github.com/knocklabs/telegraph/commit/061bb9367a211650add6e2f54cbce5c85b69a137)]:
  ...
  - @telegraph/input@0.0.39
  - @telegraph/menu@0.0.57
  - @telegraph/tag@0.0.78
  - @telegraph/tooltip@0.0.41
...
- Updated dependencies [[`2925a69`](https://github.com/knocklabs/telegraph/commit/2925a699379f14b08fc91d2c5f84a143dfda01eb)]:
  ...
  - @telegraph/menu@0.0.51
  - @telegraph/tag@0.0.72
...
- Updated dependencies [[`19d31b1`](https://github.com/knocklabs/telegraph/commit/19d31b165203c8a00186733b35d83c70bcbf32fc)]:
  ...
  - @telegraph/menu@0.0.50
  - @telegraph/tag@0.0.71
...
- Updated dependencies [[`1a6d741`](https://github.com/knocklabs/telegraph/commit/1a6d7418990003585f58c64d7a8d023e8058b021)]:
  ...
  - @telegraph/menu@0.0.49
  - @telegraph/tag@0.0.70
...
- Updated dependencies [[`47723a4`](https://github.com/knocklabs/telegraph/commit/47723a426e1734d6bfa6c69000690875d0d101cc)]:
  ...
  - @telegraph/input@0.0.33
