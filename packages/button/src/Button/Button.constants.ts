export const buttonColorMap = {
  solid: {
    ...
    green: "bg-green-9 hover:bg-green-10 focus:bg-green-11",
    blue: "bg-blue-9 hover:bg-blue-10 focus:bg-blue-11",
    yellow: "bg-yellow-9 hover:bg-yellow-10 focus:bg-yellow-11",
    disabled: "bg-gray-2",
  },
  soft: {
    ...
    green: "bg-green-3 hover:bg-green-4 focus:bg-green-5",
    blue: "bg-blue-3 hover:bg-blue-4 focus:bg-blue-5",
    yellow: "bg-yellow-3 hover:bg-yellow-4 focus:bg-yellow-5",
    disabled: "bg-gray-2",
  },
  outline: {
    ...
    green:
      "bg-transparent shadow-[inset_0_0_0_1px] shadow-green-6 hover:shadow-green-7 focus:shadow-green-8",
    blue: "bg-transparent shadow-[inset_0_0_0_1px] shadow-blue-6 hover:shadow-blue-7 focus:shadow-blue-8",
    yellow:
      "bg-transparent shadow-[inset_0_0_0_1px] shadow-yellow-6 hover:shadow-yellow-7 focus:shadow-yellow-8",
    disabled: "bg-gray-2",
  },
  ghost: {
    ...
    green: "bg-transparent hover:bg-green-3 focus:bg-green-4",
    blue: "bg-transparent hover:bg-blue-3 focus:bg-blue-4",
    yellow: "bg-transparent hover:bg-yellow-3 focus:bg-yellow-4",
